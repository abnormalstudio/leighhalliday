...
tags: javascript, fundamentals, arrays, reduce
date: 2020-05-09
updated: 2020-05-09
banner: ./banner.jpg
---
...
1. The accumulator is not null, meaning we have already found the value, so let's return it.
2. The current array element meets our criteria, so let's return it.
3. By returning null we tell the next iteration that the value has not yet been found.
