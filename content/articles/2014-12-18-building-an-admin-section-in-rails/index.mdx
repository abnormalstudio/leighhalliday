...
When using namespaces, we can use our url helper methods, all prefixed with __admin__. `admin_root_path`, `admin_categories_path`, etc... 
...
<img src="https://s3.amazonaws.com/leighhalliday/manual/admin-post.png" style="max-width: 100%;" /> 
...
Another great gem is [Will Paginate](https://github.com/mislav/will_paginate) which allows us to easily paginate the results on our index pages. By calling the __paginate__ method, we're able to get paginated results. By default I think it shows around 30 results per page. 
