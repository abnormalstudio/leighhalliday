...
In a great article written about [storing tree structures in the database](http://railsware.com/blog/2013/07/15/storing-tree-structures-in-the-rdbms/), Alexey outlines 3 common patterns. They are __parent-child__, __materialized path__, and __nested set__. 
...
- `1` Colombia `10`, __L1__ 
  - `2` Antioquia `7`, __L2__ 
    - `3` Medellín `4`, __L3__ 
    - `5` Rio Negro `6`, __L3__ 
  - `8` Chocó `9`, __L2__ 
